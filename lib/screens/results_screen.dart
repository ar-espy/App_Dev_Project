...
class _ResultsScreenState extends State<ResultsScreen> {
                        ...
                        child: Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              SizedBox(height: 20),
                              Text('Plan for distribution of resources:', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                              _buildTable(),
                            ],
                          ),
                        ),
  ...
  Widget _buildSankeyDiagram() {
    ...
    // Calculate the required width and height for the diagram
    double maxWidth = nodes.length * 150.0;
    double maxHeight = 400.0; // Fixed height for the diagram

    // Scale the nodes and links to fit within the card
    double scaleX = (MediaQuery.of(context).size.width * 0.9) / maxWidth;
    double scaleY = maxHeight / 400.0;
